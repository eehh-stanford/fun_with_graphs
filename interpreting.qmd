...
My personal favorite color-palette package is `MetBrewer`, which translates the color schemes of various masterworks from the [Metropolitan Museum of Art](https://www.metmuseum.org/). You can check out the various palettes and the works that inspired them on the [MetBrewer GitHub](https://github.com/BlakeRMills/MetBrewer).
